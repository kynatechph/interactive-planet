...
const params = {
  ...
  mapPoints:{
    ...
    sizeOfPoints:0.2,// !FLOAT ONLY! | MIN: 0.1 , MAX: 0.4
    opacityOfOceanPoints:0.2,// !FLOAT ONLY! | ex. 0.1 | MIN: 0.1 - black, MAX: 0.9
...
const data=[
  ...
  { // FROM CHINA
    ...
    lineColor:'#F8AE29',// HEX Color | Default params.colors.lineColor | Line color in HEX, ex. 0xffffff - it's white
    ...
    stickHeight:1.5, // Integer or Float | Default 1.1 | min ≈1, max ≈5 | ex. for randomization it: THREE.Math.randFloat(.5, 2).toFixed(2) | Arrives line height
    stickWidth:.05, // Float | Default 0.1 | min ≈.01, max ≈.2 | ex. for randomization it: THREE.Math.randFloat(.5, 2).toFixed(2) | Arrives line height
    // NEW
    text:``, // String | Max: 50 symbol | ex. 'This is Pekin'
    ...
    to:{lat:14.583865670201368, lon:120.97679262915449},// REQUIRED | TO   MANILA
  },
